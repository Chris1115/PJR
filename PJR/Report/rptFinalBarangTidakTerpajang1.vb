...
Public Class rptFinalBarangTidakTerpajang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFinalBarangTidakTerpajang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFinalBarangTidakTerpajang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFinalBarangTidakTerpajang = New rptFinalBarangTidakTerpajang()
        rpt.Site = Me.Site
        Return rpt
    End Function
