...
Public Class rptListingDisplayProduk
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListingDisplayProduk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListingDisplayProduk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListingDisplayProduk = New rptListingDisplayProduk()
        rpt.Site = Me.Site
        Return rpt
    End Function
