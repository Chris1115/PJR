...
Public Class rptBarangTidakTerpajang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBarangTidakTerpajang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarangTidakTerpajang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarangTidakTerpajang = New rptBarangTidakTerpajang()
        rpt.Site = Me.Site
        Return rpt
    End Function
