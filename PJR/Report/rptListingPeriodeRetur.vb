...
Public Class rptListingPeriodeRetur
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListingPeriodeRetur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListingPeriodeRetur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListingPeriodeRetur = New rptListingPeriodeRetur()
        rpt.Site = Me.Site
        Return rpt
    End Function
