...
Public Class rptListItemBAPJR_AS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListItemBAPJR_AS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListItemBAPJR_AS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListItemBAPJR_AS = New rptListItemBAPJR_AS()
        rpt.Site = Me.Site
        Return rpt
    End Function
