...
Public Class rptLaporanJadwalPJR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLaporanJadwalPJR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLaporanJadwalPJR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLaporanJadwalPJR = New rptLaporanJadwalPJR()
        rpt.Site = Me.Site
        Return rpt
    End Function
