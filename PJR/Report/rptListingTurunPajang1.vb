...
Public Class rptListingTurunPajang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListingTurunPajang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListingTurunPajang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListingTurunPajang = New rptListingTurunPajang()
        rpt.Site = Me.Site
        Return rpt
    End Function
